//! Gamepad input handling using the gamepads crate
...
pub struct GamepadInput {
    ...
    pub minimap_zoom_in_pressed: bool,  // D-pad right (during gameplay)
    pub minimap_zoom_out_pressed: bool, // D-pad left (during gameplay)
